...
class ShowcaseActivity : AppCompatActivity(), OnIndexChangedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        showcaseModels =
            extras.getParcelableArrayList<ShowcaseModel>(EXTRAS_SHOWCASES) as ArrayList<ShowcaseModel>
    ...
    override fun onChanged(index: Int) {
        ...
        val isBtnNextSelected =
            (index + 1) < showcaseModels.size//At the last item imgNext.isSelected = false
